...
listaCartasCreadas = [
    ...
    CartaMagica("Espada de Arturo", "Incrementa el ataque de guerreros", Posicion.HORIZONTAL, Orientacion.ABAJO, 200, 0, TipoMonstruo.G),
    CartaMagica("Escudo de Chamelote", "Incrementa la defensa de guerreros", Posicion.HORIZONTAL, Orientacion.ABAJO, 0, 200, TipoMonstruo.G),
    CartaMagica("Poder de la Luz", "Incrementa el ataque de monstruos de luz", Posicion.HORIZONTAL, Orientacion.ABAJO, 300, 0, TipoMonstruo.L),
    CartaMagica("Fuerza de la Oscuridad", "Incrementa la defensa de monstruos oscuros", Posicion.HORIZONTAL, Orientacion.ABAJO, 0, 300, TipoMonstruo.D),
    CartaMagica("Llama Ardiente", "Incrementa el ataque de monstruos de fuego", Posicion.HORIZONTAL, Orientacion.ABAJO, 400, 0, TipoMonstruo.O),
    CartaMagica("Barrera Protectora", "Aumenta la defensa de todos los monstruos", Posicion.HORIZONTAL, Orientacion.ABAJO, 0, 150, TipoMonstruo.B),
    CartaMagica("Espada Ardiente", "Aumenta el ataque de los monstruos fuego", Posicion.HORIZONTAL, Orientacion.ABAJO, 250, 0, TipoMonstruo.Z),
    CartaMagica("Luz Radiante", "Aumenta el ataque de los monstruos de luz", Posicion.HORIZONTAL, Orientacion.ABAJO, 300, 0, TipoMonstruo.L),
    CartaMagica("Escudo del Guerrero", "Aumenta la defensa de los guerreros", Posicion.HORIZONTAL, Orientacion.ABAJO, 0, 200, TipoMonstruo.G),
    CartaMagica("Fuerza Viento", "Aumenta el ataque de los monstruos viento", Posicion.HORIZONTAL, Orientacion.ABAJO, 250, 0, TipoMonstruo.B),
    CartaMagica("Magia Curativa", "Recupera 1000 puntos de vida", Posicion.HORIZONTAL, Orientacion.ABAJO, 0, 0, TipoMonstruo.L),
    CartaMagica("Potencia Oscura", "Incrementa el ataque de monstruos oscuros", Posicion.HORIZONTAL, Orientacion.ABAJO, 300, 0, TipoMonstruo.D),
    CartaMagica("Tornado Mágico", "Destruye una carta mágica o trampa", Posicion.HORIZONTAL, Orientacion.ABAJO, 0, 0, TipoMonstruo.O),
    CartaMagica("Fuerza Espiritual", "Aumenta la defensa de los monstruos de luz", Posicion.HORIZONTAL, Orientacion.ABAJO, 0, 300, TipoMonstruo.L),
    CartaMagica("Fuego Eterno", "Aumenta el ataque de los monstruos fuego", Posicion.HORIZONTAL, Orientacion.ABAJO, 300, 0, TipoMonstruo.Z),
    CartaMagica("Escudo Divino", "Aumenta la defensa de los monstruos de fuego", Posicion.HORIZONTAL, Orientacion.ABAJO, 0, 250, TipoMonstruo.D),
    CartaMagica("Luz Brillante", "Aumenta el ataque de los monstruos de luz", Posicion.HORIZONTAL, Orientacion.ABAJO, 200, 0, TipoMonstruo.L),
    CartaMagica("Viento Cortante", "Aumenta el ataque de los monstruos de viento", Posicion.HORIZONTAL, Orientacion.ABAJO, 250, 0, TipoMonstruo.B),
    CartaMagica("Escudo del Guerrero", "Aumenta la defensa de los guerreros", Posicion.HORIZONTAL, Orientacion.ABAJO, 0, 200, TipoMonstruo.G),
    CartaMagica("Destello Luminiscente", "Aumenta la defensa de monstruos de luz", Posicion.HORIZONTAL, Orientacion.ABAJO, 0, 300, TipoMonstruo.L),

    # Cartas Trampa (15 cartas)
    CartaTrampa("Tornado de Polvo", "Detiene el ataque de monstruos con atributo VIENTO", Posicion.HORIZONTAL, Orientacion.ABAJO, TipoAtributo.VIENTO),
    CartaTrampa("Barrera de Fuego", "Detiene el ataque de monstruos con atributo FUEGO", Posicion.HORIZONTAL, Orientacion.ABAJO, TipoAtributo.FUEGO),
    CartaTrampa("Escudo del Agua", "Detiene el ataque de monstruos con atributo AGUA", Posicion.HORIZONTAL, Orientacion.ABAJO, TipoAtributo.AGUA),
    CartaTrampa("Escudo de Tierra", "Detiene el ataque de monstruos con atributo TIERRA", Posicion.HORIZONTAL, Orientacion.ABAJO, TipoAtributo.TIERRA),
    CartaTrampa("Oscuridad Eterna", "Detiene el ataque de monstruos con atributo OSCURIDAD", Posicion.HORIZONTAL, Orientacion.ABAJO, TipoAtributo.OSCURIDAD),
    CartaTrampa("Luz Radiante", "Detiene el ataque de monstruos con atributo LUZ", Posicion.HORIZONTAL, Orientacion.ABAJO, TipoAtributo.LUZ),
    CartaTrampa("Ataque de Viento", "Detiene el ataque de monstruos con atributo VIENTO", Posicion.HORIZONTAL, Orientacion.ABAJO, TipoAtributo.VIENTO),
    CartaTrampa("Barrera Sagrada", "Detiene el ataque de monstruos con atributo TIERRA", Posicion.HORIZONTAL, Orientacion.ABAJO, TipoAtributo.TIERRA),
    CartaTrampa("Llamas Infinitas", "Detiene el ataque de monstruos con atributo FUEGO", Posicion.HORIZONTAL, Orientacion.ABAJO, TipoAtributo.FUEGO),
    CartaTrampa("Reflejo Oscuro", "Detiene el ataque de monstruos con atributo OSCURIDAD", Posicion.HORIZONTAL, Orientacion.ABAJO, TipoAtributo.OSCURIDAD),
    CartaTrampa("Barrera de Hielo", "Detiene el ataque de monstruos con atributo AGUA", Posicion.HORIZONTAL, Orientacion.ABAJO, TipoAtributo.AGUA),
    CartaTrampa("Manto de Fuego", "Detiene el ataque de monstruos con atributo FUEGO", Posicion.HORIZONTAL, Orientacion.ABAJO, TipoAtributo.FUEGO),
    CartaTrampa("Sombra Oscura", "Detiene el ataque de monstruos con atributo OSCURIDAD", Posicion.HORIZONTAL, Orientacion.ABAJO, TipoAtributo.OSCURIDAD),
    CartaTrampa("Viento Cortante", "Detiene el ataque de monstruos con atributo VIENTO", Posicion.HORIZONTAL, Orientacion.ABAJO, TipoAtributo.VIENTO),
    CartaTrampa("Reflejo de Luz", "Detiene el ataque de monstruos con atributo LUZ", Posicion.HORIZONTAL, Orientacion.ABAJO, TipoAtributo.LUZ)
]